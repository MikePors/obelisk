...
public enum Check {
    ...
    REJECT_LOCAL_NAME_COLLISION,
    REJECT_NESTED_SELF_CALL,
    REJECT_NEW_NAME_ALREADY_BOUND,
    REJECT_SHADOWED_BINDING_NOT_QUALIFIABLE,
